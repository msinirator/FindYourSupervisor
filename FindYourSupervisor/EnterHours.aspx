<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EnterHours.aspx.vb" Inherits="FindYourSupervisor.EnterHours" %>
        ...
        <div>
            ...
            <asp:Panel ID="Panel1" runat="server" 
                ...
                <asp:TextBox ID="txtHours" runat="server" 
                    Style="position: absolute; left: 609px; top: 214px; 
                       width: 158px; font-weight: bold; font-size: 12pt;
                       font-family: Arial; text-align: center">
                </asp:TextBox>
        

                <asp:Button ID="cmdUpdate" runat="server" Text="Update"
                    Style="position: absolute; left: 651px; top: 314px; width: 80px;
